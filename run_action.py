...
def main():
    ...
    if detection_result == clone_code_detection.ReturnCode.BAD_INPUT:
        print("Action aborted due to bad user input")
        return detection_result.value
    elif detection_result == clone_code_detection.ReturnCode.THRESHOLD_EXCEEDED:
        print(
    ...
    message += "The [tool](https://github.com/cs19b005-gautam/se-tool/)"
