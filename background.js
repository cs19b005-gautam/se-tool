              ...
              overflow: hidden;
                  ...
                  background: #FFFFFF;background: #8A9AF7;transition: 0.3s;margin-left:0.5rem;margin-right:0.5rem;">
                      ...
                      <div style="display: flex;margin: 1.5rem;">
                          ...
                          <div style="flex: 4;background: #ffffff;padding: 3rem;padding-left: 1rem; padding-right: 0;box-shadow: 0 10px 10px rgba(0, 0, 0, 0.2);">
...
function add_insights() {
  ...
  metricJSON["C_Class"] = document.getElementById("f7").innerHTML
  ...
  if (closed_bugs >= (2 * open_bugs)) {
    bug_insight = `
                   <div class="icon icon__safe" style="margin-left: 42rem;" >
    ...
    bug_insight = `
                    <div class="icon icon__ok" style="margin-left: 42rem;" >
    ...
    bug_insight = `
                                          <div class="icon icon__danger" style="margin-left: 42rem;">
  ...
  if (ifiles <= 10) {
    file_insight = `
                                          <div class="icon icon__safe" style="margin-left: 8rem;" >
                                          <div style="font-family: 'Varela Round', sans-serif;" class="insight insight__safe">
                                              Greatly modularized. New version will minimally affect the project. 
                                          </div>
                                          <img style="width: 1rem;height: 2rem;" src="https://img.icons8.com/color/48/000000/code-file.png"/>
                                      </div>`;
  }
  else if (ifiles >= 11) {
    if (ifiles > 40) {
      file_insight = `
                                              <div class="icon icon__danger" style="margin-left: 8rem;">
                                              <div style="font-family: 'Varela Round', sans-serif;" class="insight insight__danger">
      ...
      file_insight = `
                                              <div class="icon icon__ok" style="margin-left: 8rem;">
                                              <div style="font-family: 'Varela Round', sans-serif;" class="insight insight__ok">
  ...
  setTimeout(() => {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        document.getElementById('f6').style.background = '#44CC11'
        document.getElementById('f7').innerHTML = scm["C_Class"]
        document.getElementById('f7').style.background = '#44CC11'
      } else {
