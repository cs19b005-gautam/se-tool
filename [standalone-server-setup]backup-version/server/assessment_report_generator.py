...
def clone_analysis():
    percentage_fp = open("percentage.txt","r")
    percentage_string = ""
    for line in percentage_fp:
        percentage_string = percentage_string+line
        break
    percentage = float(percentage_string)
    mongoJSON["C_Class"] = percentage
    percentage_fp.close()

    clone_pair_string_fp = open("clone_pair_string.txt", "r")
    clone_pair_string = ""
    for line in clone_pair_string_fp:
        clone_pair_string = clone_pair_string+line
        break
    mongoJSON["Clone_String"] = clone_pair_string
    clone_pair_string_fp.close()
...
if __name__ == "__main__":
    ...
    val = (project_id,commit_id,repo_url,mongoJSON["N_Pack"],mongoJSON["D_Pack"],mongoJSON["N_Methods"],mongoJSON["O_Methods"],mongoJSON["N_Class"],mongoJSON["I_Class"],mongoJSON["C_Class"],mongoJSON["Code_Impact"],mongoJSON["Code_Churn"],mongoJSON["Open_Bugs"],mongoJSON["Closed_Bugs"], mongoJSON["Percentage_Active_Contributors"], mongoJSON["Active_Contributors"], mongoJSON["Clone_String"])
    QUERY = '''
    INSERT OR REPLACE INTO `assessment_report`
    (`project_sequence`,`commit_id`,`url`,`N_Pack`,`D_Pack` ,`N_Methods`,`O_Methods` ,`N_Class`,`I_Class`, `C_Class`  ,`Code_Impact`,`Code_Churn` ,`Open_Bugs`, `Closed_Bugs`,`Percentage_Active_Contributors`,`Active_Contributors`,`Clone_String`)
    VALUES
    (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)'''
